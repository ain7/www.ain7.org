...
def filldb():
    ...
    travel1.prix = 2350
    travel1.description="<p>Le compte rendu est <a href=\"/site_media/data/CR_Vistule2007.pdf\">ici</a>.</p>"
    travel1.save()

#     ce voyage n'apparait plus sur le site de l'AI (annule?)
...
#     travel2.prix = 3890
#     f = open('filldb-voyageJapon06.html','r')
#     travel2.description = f.read()
#     f.close()
#     travel2.save()
    ...
    travel6.prix = 2430
    travel6.description="<p>Le compte rendu est <a href=\"/site_media/data/CR_Mexique2007.pdf\">ici</a>.</p>"
    travel6.save()

    travel7 = voyages.Travel()
    travel7.label = "Inde - Gujarat & Rajasthan"
    travel7.start_date = date(2007,11,1)
    travel7.end_date = date(2007,11,30)
    travel7.date = "Novembre 2006"
    travel7.type = looptravel
    travel7.visited_places = "Gujarat, Rajasthan"
    travel7.thumbnail = "data/inde06-3.jpg"
    f = open('filldb-voyageInde06.html','r')
    travel7.description = f.read()
    f.close()
    travel7.save()
