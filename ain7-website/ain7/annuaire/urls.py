...
urlpatterns = patterns('',
    ...
    (r'^advanced_search/sessionFilter/criterion/add/$',
     criterion_add),
    (r'^advanced_search/sessionFilter/criterion/edit/$',criterion_edit),
    (r'^advanced_search/sessionFilter/criterion/(?P<criterion_id>\d+)/edit/$',criterion_edit),
    ...
    (r'^advanced_search/filter/(?P<filter_id>\d+)/criterion/add/$',
     criterion_add),
    (r'^advanced_search/filter/(?P<filter_id>\d+)/criterion/edit/$',
     criterion_edit),
    (r'^advanced_search/filter/(?P<filter_id>\d+)/criterion/(?P<criterion_id>\d+)/edit/$',
     criterion_edit),
    (r'^advanced_search/filter/(?P<filter_id>\d+)/criterion/(?P<criterion_id>\d+)/delete/$',
     criterion_delete),
    # Edition
