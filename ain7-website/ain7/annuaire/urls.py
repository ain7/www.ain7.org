...
urlpatterns = patterns('',
    ...
    (r'^advanced_search/sessionFilter/swapOp/$', filter_swapOp),
    (r'^advanced_search/sessionFilter/criterion/add/$',
     criterion_add),
    (r'^advanced_search/sessionFilter/criterion/add/field/$',
     criterion_add, {'criterionType': 'field'}),
    (r'^advanced_search/sessionFilter/criterion/add/filter/$',
     criterion_add, {'criterionType': 'filter'}),
    (r'^advanced_search/sessionFilter/criterion/edit/field/$',criterionField_edit),
    (r'^advanced_search/sessionFilter/criterion/edit/filter/$',criterionFilter_edit),
    (r'^advanced_search/sessionFilter/criterion/(?P<criterion_id>\d+)/edit/field/$',criterionField_edit),
    (r'^advanced_search/sessionFilter/criterion/(?P<criterion_id>\d+)/edit/filter/$',criterionFilter_edit),
    (r'^advanced_search/sessionFilter/criterion/(?P<criterion_id>\d+)/delete/field/$',sessionCriterion_delete, {'criterionType':'field'}),
    (r'^advanced_search/sessionFilter/criterion/(?P<criterion_id>\d+)/delete/filter/$',sessionCriterion_delete, {'criterionType':'filter'}),
    # Advanced search: filter saved in database
    (r'^advanced_search/filter/add/$', sessionFilter_reset),
    ...
    (r'^advanced_search/filter/(?P<filter_id>\d+)/reset/$',
     filter_reset),
    (r'^advanced_search/filter/(?P<filter_id>\d+)/delete/$',
     filter_delete),
    (r'^advanced_search/filter/(?P<filter_id>\d+)/swapOp/$',
     filter_swapOp),
