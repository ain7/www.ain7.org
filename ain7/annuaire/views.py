...
def home(request, user_name):
    ...
    return details(request, person_id)


@login_required
def me(request):
    person_id = Person.objects.get(user=request.user).id
    return edit(request, person_id)
...
@login_required
def change_credentials(request, person_id):
    person = get_object_or_404(Person, pk=person_id)
    is_myself = int(request.user.id) == int(person.user.id)

    if not is_myself:
        return HttpResponseRedirect(
            reverse(details, args=[person.pk]))
...
def send_new_credentials(request, person_id):
...
@access_required(groups=['ain7-secretariat'])
def set_new_credentials(request, person_id):
    """Send a link for reseting password"""
...
def person_edit(request, person_id=None):
    ...
    PersonForm = modelform_factory(
        Person, fields=(
            ...
            'birth_date', 'sex', 'nationality', 'year', 'track',
            )
    )
    form = PersonForm(request.POST or None, instance=person or None)
...
def personprivate_edit(request, person_id):
...
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def ain7member_edit(request, person_id):
...
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def address_edit(request, person_id=None, address_id=None):
    ...
    AddressForm = modelform_factory(Address, exclude=('person', 'confidentiality', 'is_valid',))
...
@confirmation_required(lambda person_id=None, address_id=None:
    str(get_object_or_404(Address, pk=address_id)), 'annuaire/base.html',
    _('Do you really want to delete your address'))
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def address_delete(request, person_id=None, address_id=None):

    return ain7_generic_delete(request,
        get_object_or_404(Address, pk=address_id),
        '/annuaire/%s/edit/#address' % person_id,
        _('Address successfully deleted.'))


@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def phone_edit(request, person_id=None, phone_id=None):
    ...
    PhoneNumberForm = modelform_factory(PhoneNumber, exclude=('person', 'confidentiality'))
...
@confirmation_required(lambda person_id=None, phone_id=None:
    str(get_object_or_404(PhoneNumber, pk=phone_id)), 'annuaire/base.html',
    _('Do you really want to delete your phone number'))
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def phone_delete(request, person_id=None, phone_id=None):

    return ain7_generic_delete(request,
        get_object_or_404(PhoneNumber, pk=phone_id),
        '/annuaire/%s/edit/#phone' % person_id,
        _('Phone number successfully deleted.'))


@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def email_edit(request, person_id=None, email_id=None):
    ...
    EmailForm = modelform_factory(Email, exclude=('person', 'confidentiality'))
...
def website_edit(request, person_id=None, website_id=None):
    ...
    WebSiteForm = modelform_factory(WebSite, exclude=('person', 'confidentiality', 'blog_is_agregated_on_planet'))
...
@confirmation_required(lambda person_id=None, website_id=None:
    str(get_object_or_404(WebSite, pk=website_id)), 'annuaire/base.html',
    _('Do you really want to delete your website'))
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def website_delete(request, person_id=None, website_id=None):

    return ain7_generic_delete(request,
        get_object_or_404(WebSite, pk=website_id),
        '/annuaire/%s/edit/#website' % person_id,
        _('Website successfully deleted.'))


# Vie associative a l'n7
@access_required(groups=['ain7-secretariat', 'ain7-ca'], allow_myself=True)
def club_membership_edit(request, person_id=None, club_membership_id=None):
...
def add(request, person_id=None):
    ...
    NewMemberForm = modelform_factory(
        Person, fields=(
            'first_name', 'last_name', 'mail', 'nationality',
            'birth_date', 'sex', 'year', 'track',
            )
    )
...
@confirmation_required(lambda person_id=None, position_id=None:
    str(get_object_or_404(Position, pk=position_id)), 'emploi/base.html',
    _('Do you really want to delete your position'))
@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def position_delete(request, person_id=None, position_id=None):
    """position delete"""

    return ain7_generic_delete(
        request,
        get_object_or_404(Position, pk=position_id),
        reverse(edit, args=[person_id]) + '#prof_exp',
        _('Position successfully deleted.')
    )


@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def education_edit(request, person_id=None, education_id=None):
    """education edit"""
...
@confirmation_required(lambda person_id=None, education_id=None:
    str(get_object_or_404(EducationItem, pk=education_id)), 'emploi/base.html',
    _('Do you really want to delete your education item'))
@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def education_delete(request, person_id=None, education_id=None):
    """education delete"""

    return ain7_generic_delete(
        request,
        get_object_or_404(EducationItem, pk=education_id),
        reverse(edit, args=[person_id]) + '#education',
        _('Education informations deleted successfully.')
    )


@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def leisure_edit(request, person_id=None, leisure_id=None):
    """leisure edit"""
...
@confirmation_required(lambda person_id=None, leisure_id=None:
    str(get_object_or_404(LeisureItem, pk=leisure_id)), 'emploi/base.html',
    _('Do you really want to delete your leisure item'))
@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def leisure_delete(request, person_id=None, leisure_id=None):
    """leisure delete"""

    return ain7_generic_delete(
        request,
        get_object_or_404(LeisureItem, pk=leisure_id),
        reverse(edit, args=[person_id]) + '#leisure',
        _('Leisure informations successfully deleted.')
    )


@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def publication_edit(request, person_id=None, publication_id=None):
    """publication edit"""
...
@confirmation_required(lambda person_id=None, publication_id=None:
    str(get_object_or_404(PublicationItem, pk=publication_id)),
    'emploi/base.html',
    _('Do you really want to delete your publication'))
@access_required(groups=['ain7-ca', 'ain7-secretariat'], allow_myself=True)
def publication_delete(request, person_id=None, publication_id=None):
    """publication delete"""

    return ain7_generic_delete(
        request,
        get_object_or_404(PublicationItem, pk=publication_id),
        reverse(edit, args=[person_id]) + '#publications',
