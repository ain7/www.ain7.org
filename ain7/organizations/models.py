...
class OrganizationActivityField(models.Model):
    ...
    code = models.CharField(
        verbose_name=_('code'), max_length=100, unique=True,
    )
...
class Organization(LoggedClass):
    ...
    long_description = models.TextField(
        verbose_name=_('long description'), blank=True, null=True,
    )
    employment_agency = models.BooleanField(
        verbose_name=_('employment agency'), default=False,
    )
    ...
    modification_of = models.ForeignKey(
...
class Office(LoggedClass):
    ...
    country = models.ForeignKey(
        'annuaire.Country', verbose_name=_('country'), blank=True, null=True,
    )
    phone_number = models.CharField(
        verbose_name=_('phone number'), max_length=20, blank=True, null=True,
    )
    fax_number = models.CharField(
        verbose_name=_('fax number'), max_length=20, blank=True, null=True,
    )
    ...
    modification_of = models.ForeignKey(
        'organizations.Office', null=True, blank=True,
    )
    modification_date = models.DateTimeField(null=True, blank=True)
    ...
    def past_n7_employees(self):
        ...
        for position in self.positions.all():
            ...
            # employés
            if ain7member not in liste_n7_current:
